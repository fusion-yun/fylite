...
| `U-` | `FYL-DESIGN-18` | U-1..U-20 | 应用前端：输入生成 · 源栈 · 执行与断点 · 呈现规格 · 交互图形 · 文档集；下一号 U-21。★`-18` 的 `J-` 是判据不是裁定，与 `-17` 的 `J-` 各在各篇内唯一 |
