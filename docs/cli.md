...
```console
$ fy run examples/evolve/evolve-default.jsonld nsteps=20 -o rec/a
$ fy run examples/evolve/evolve-default.jsonld nsteps=20 --resume-from rec/a -o rec/b
```
...
code 那一层没有一处声明它收什么。所以续跑走上面那条命令行，
它经文档门，名字是内核的。
