...
| 记录 | 类 | 判决 | 参考 | 版本 | 评审 | 正本 |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| [`tr-pedestal-eped-feedback`](../../reports/tr-pedestal-eped-feedback.md) | 验证 | 成立 | EPEDNN.jl · 反馈的不动点：下一步的 EPED-NN 目标等于本步的边界 | 1.2 | 草稿 | [jsonld](../../records/tr-pedestal-eped-feedback.jsonld) |
| [`tr-pedestal-sawtooth-kadomtsev`](../../reports/tr-pedestal-sawtooth-kadomtsev.md) | 验证 | 成立 | 它自己混合前的含量积分，以及 Kadomtsev 重联要求的 q = 1 | 1.21 | 草稿 | [jsonld](../../records/tr-pedestal-sawtooth-kadomtsev.jsonld) |
| [`tr-pedestal-zerod-bookkeeping-metis`](../../reports/tr-pedestal-zerod-bookkeeping-metis.md) | 对拍 | 成立 | METIS | 1.27 | 草稿 | [jsonld](../../records/tr-pedestal-zerod-bookkeeping-metis.jsonld) |
