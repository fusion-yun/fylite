...
- 内核 `libfylite` `sha256:7721e88aac1f453ef4b6dae805a592bdc29628825e8ffb71a17910a4019927fb`　—— 须设 `$FYLITE_KERNEL_LIB` 指向带该门的构建，并设 `$FYLITE_DEVICE_DIR` 指向 ITER 牌所在目录
