...
- 内核 `libfylite` `sha256:7721e88aac1f453ef4b6dae805a592bdc29628825e8ffb71a17910a4019927fb`　—— ★本条**尚无门**：`docs/benchmark/readings/` 里有读数，但还没有一道 pytest 守它。这是记名的下一步，见 open_defect。
