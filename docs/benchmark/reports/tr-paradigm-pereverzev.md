...
- 内核 `libfylite` `sha256:ac8c0f5cdc4e601951da0b1ad26a58616571913de15e1bd089065e8a94dc0e7a`　—— 与 `meta/kernel.json` 的基准内核一致——本记录记在当前内核上。
