...
- 首次入册 2026-09-16　末次修订 2026-09-18　版本 1.11　评审 草稿
...
- 内核 `libfylite` `sha256:c5b0d8699709dea9f7e7b27b20f55bdbf2bf790944da28ddafafa4c4fa82f957`　—— 与 `meta/kernel.json` 的基准内核一致——本记录记在当前内核上。
