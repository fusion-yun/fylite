...
- 内核 `libfylite` `sha256:3250d2a411eae26a58930a6c611468d94724d3610dcef2da735a6c6ab3418338`　—— ★须设 `$FYLITE_KERNEL_LIB` 指向带 code/fixed_boundary 的构建：不设时会加载滞后的运行时预编译件，门当场按名拒绝（-30）。
