...
复测结论：不成立 1、成立 23、未评估 1。★跨类不可比：V/B/C 问的不是同一个问题（README）。
...
| :-- | :-- | :-- | :-- | :-- | :-- | :-- |
| V-01 | V | GACODE | public、public-derived、restricted-derived | 成立 | 不成立（92 passed, 2 failed, 0 error, 0 skipped, 2 stale） | [V-01](V-01-gacode-ports.md) |
