...
46 条记录，18 个场景；★2026-09-15：平衡相关的 V-16 · V-17 · B-12 · B-14 · V-18 · B-15 由公开检出的 `tools/benchmark-equilibrium-records.py` 直写（用户裁定「完善平衡相关 benchmark，不动 fylite_kernel」「废弃 libefit 对标，直接对标 KEFIT」），复测列是写入当日的；C-06 · C-07 · B-10 并入 V-16，B-06 · B-11 由 B-12 取代，C-03 的门自 2026-09-14 起 skip。★2026-09-15（第二批）：定边界 V-19 · B-16 同一工具直写（用户「补全 fixed-boundary 情景」；内核当日新增 `code/fixed_boundary`），B-10 原题由它们立。★2026-09-15（第二批）：导体壁 B-17 与垂直不稳定性 B-18（对 FreeGSNKE，用户「补全导体壁，垂直不稳定性算例」；内核当日新增 `code/wall` 并修正 EFIT 平行四边形读法）同一工具直写，C-03 由 B-18 取代。由 `tools/benchmark-publish.py`（内核仓）自登记册渲染，复测 2026-09-08。
