...
| 需求 | 级别 | 标题 | 覆盖它的记录 | 类 | 判决 |
| :--- | :--- | :--- | :--- | :--- | :--- |
| `NR-EQ-001` | MUST | COCOS 一致性 | [`eq-convention-gfile-cocos-roundtrip`](reports/eq-convention-gfile-cocos-roundtrip.md) · [`eq-convention-ladder-flux-gauge`](reports/eq-convention-ladder-flux-gauge.md) | 验证 · 验证 | 成立 · 成立 |
...
| 需求 | 级别 | 标题 | 覆盖它的记录 | 类 | 判决 |
| :--- | :--- | :--- | :--- | :--- | :--- |
| `FR-EQ-019` | MUST | 能量原理变分内核（L2 的 B1：柱极限） | [`mhd-energy-variational-cylinder`](reports/mhd-energy-variational-cylinder.md) | 验证 | 成立 |
| `FR-EQ-020` | MUST | 环几何耦合的组装机器（L2 的 B2 机器面） | [`mhd-energy-coupled-assembly`](reports/mhd-energy-coupled-assembly.md) | 验证 | 成立 |
...
| `FR-TR-006` | MUST | 耦合隐式块解（可选，候选 ADR） | [`tr-paradigm-coupled-block-adr`](reports/tr-paradigm-coupled-block-adr.md) | 验证 | 成立 |
...
| 需求 | 级别 | 标题 | 覆盖它的记录 | 类 | 判决 |
| :--- | :--- | :--- | :--- | :--- | :--- |
| `FR-TR-011` | MUST | 解释性 / 分析模式通量反演（路线项） | [`tr-coupling-interpretive-inversion`](reports/tr-coupling-interpretive-inversion.md) | 验证 | 成立 |
