...
- `libfylite` **sha256:e15d03f542fa89ea…**
...
- 记录 (records)：**37** 条
- 判决 (verdict)：成立 27 · 不成立 **1** · 未判 9 · 未评估 0
- 新鲜度 (freshness)：当前 37 · **过期 0** · 未知 0
- 评审 (review)：已评审 0 · 草稿 37 · 已被取代 0
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| [`eq-convention-gfile-cocos-roundtrip`](reports/eq-convention-gfile-cocos-roundtrip.md) | eq-convention | 验证 | 成立 | 1.6 | 2026-09-18 | 草稿 | `sha256:e15d03f542fa…` | current |
| [`eq-convention-ladder-flux-gauge`](reports/eq-convention-ladder-flux-gauge.md) | eq-convention | 验证 | 成立 | 1.1 | 2026-09-18 | 草稿 | `sha256:e15d03f542fa…` | current |
| [`eq-evolve-analytic-circuit-limits`](reports/eq-evolve-analytic-circuit-limits.md) | eq-evolve | 验证 | 成立 | 1.6 | 2026-09-18 | 草稿 | `sha256:e15d03f542fa…` | current |
| [`eq-forward-boundary-rule-vs-kefit`](reports/eq-forward-boundary-rule-vs-kefit.md) | eq-forward | 对拍 | 未判（读数） | 1.6 | 2026-09-18 | 草稿 | `sha256:e15d03f542fa…` | current |
| [`eq-forward-chease-solovev`](reports/eq-forward-chease-solovev.md) | eq-forward | 对拍 | 成立 | 1.6 | 2026-09-18 | 草稿 | `sha256:e15d03f542fa…` | current |
| [`eq-forward-green-response-shared`](reports/eq-forward-green-response-shared.md) | eq-forward | 验证 | 成立 | 2.5 | 2026-09-18 | 草稿 | `sha256:e15d03f542fa…` | current |
| [`eq-forward-kefit-east137985`](reports/eq-forward-kefit-east137985.md) | eq-forward | 对拍 | 成立 | 1.6 | 2026-09-18 | 草稿 | `sha256:e15d03f542fa…` | current |
| [`eq-forward-self-contained-core`](reports/eq-forward-self-contained-core.md) | eq-forward | 验证 | 成立 | 1.7 | 2026-09-18 | 草稿 | `sha256:e15d03f542fa…` | current |
| [`eq-forward-solovev-fixed-boundary`](reports/eq-forward-solovev-fixed-boundary.md) | eq-forward | 验证 | 成立 | 1.7 | 2026-09-18 | 草稿 | `sha256:e15d03f542fa…` | current |
| [`eq-inverse-freegsnke-east137985`](reports/eq-inverse-freegsnke-east137985.md) | eq-inverse | 对拍 | 成立 | 1.6 | 2026-09-18 | 草稿 | `sha256:e15d03f542fa…` | current |
| [`eq-inverse-iter-reference-separatrix`](reports/eq-inverse-iter-reference-separatrix.md) | eq-inverse | 验证 | 未判（读数） | 1.7 | 2026-09-18 | 草稿 | `sha256:e15d03f542fa…` | current |
| [`eq-reconstruct-curvature-prior`](reports/eq-reconstruct-curvature-prior.md) | eq-reconstruct | 验证 | 成立 | 1.5 | 2026-09-18 | 草稿 | `sha256:e15d03f542fa…` | current |
| [`eq-reconstruct-fast-ion-pressure`](reports/eq-reconstruct-fast-ion-pressure.md) | eq-reconstruct | 验证 | 成立 | 1.5 | 2026-09-18 | 草稿 | `sha256:e15d03f542fa…` | current |
| [`eq-reconstruct-kefit-twin`](reports/eq-reconstruct-kefit-twin.md) | eq-reconstruct | 对拍 | 成立 | 1.6 | 2026-09-18 | 草稿 | `sha256:e15d03f542fa…` | current |
| [`eq-reconstruct-kinetic-outer`](reports/eq-reconstruct-kinetic-outer.md) | eq-reconstruct | 验证 | 成立 | 1.5 | 2026-09-18 | 草稿 | `sha256:e15d03f542fa…` | current |
| [`eq-reconstruct-posterior-bands`](reports/eq-reconstruct-posterior-bands.md) | eq-reconstruct | 验证 | 成立 | 1.0 | 2026-09-18 | 草稿 | `sha256:e15d03f542fa…` | current |
| [`eq-reconstruct-twin-observable-space`](reports/eq-reconstruct-twin-observable-space.md) | eq-reconstruct | 验证 | 成立 | 1.7 | 2026-09-18 | 草稿 | `sha256:e15d03f542fa…` | current |
| [`eq-reconstruct-twin-truth-recovery`](reports/eq-reconstruct-twin-truth-recovery.md) | eq-reconstruct | 验证 | 成立 | 1.6 | 2026-09-18 | 草稿 | `sha256:e15d03f542fa…` | current |
| [`eq-surface-chease-fixed-boundary-east`](reports/eq-surface-chease-fixed-boundary-east.md) | eq-surface | 对拍 | 成立 | 1.7 | 2026-09-18 | 草稿 | `sha256:e15d03f542fa…` | current |
| [`eq-surface-mxh-gfile-fit`](reports/eq-surface-mxh-gfile-fit.md) | eq-surface | 验证 | 未判（读数） | 1.0 | 2026-09-18 | 草稿 | `sha256:e15d03f542fa…` | current |
| [`mhd-vertical-coil-forces-analytic`](reports/mhd-vertical-coil-forces-analytic.md) | mhd-vertical | 验证 | 未判（读数） | 1.2 | 2026-09-18 | 草稿 | `sha256:e15d03f542fa…` | current |
| [`mhd-vertical-freegsnke-east137985`](reports/mhd-vertical-freegsnke-east137985.md) | mhd-vertical | 确认 | 未判（读数） | 2.1 | 2026-09-18 | 草稿 | `sha256:e15d03f542fa…` | current |
| [`tr-closure-15d-source-switches`](reports/tr-closure-15d-source-switches.md) | tr-closure | 验证 | 未判（读数） | 1.6 | 2026-09-18 | 草稿 | `sha256:e15d03f542fa…` | current |
| [`tr-closure-dt-burn-astra`](reports/tr-closure-dt-burn-astra.md) | tr-closure | 对拍 | 未判（读数） | 1.7 | 2026-09-18 | 草稿 | `sha256:e15d03f542fa…` | current |
| [`tr-closure-lazy-plugin-resolution`](reports/tr-closure-lazy-plugin-resolution.md) | tr-closure | 验证 | 成立 | 1.5 | 2026-09-18 | 草稿 | `sha256:e15d03f542fa…` | current |
| [`tr-closure-plugin-dispatch`](reports/tr-closure-plugin-dispatch.md) | tr-closure | 验证 | 成立 | 1.5 | 2026-09-18 | 草稿 | `sha256:e15d03f542fa…` | current |
| [`tr-conservation-fyo-dd-contract`](reports/tr-conservation-fyo-dd-contract.md) | tr-conservation | 验证 | 成立 | 1.5 | 2026-09-18 | 草稿 | `sha256:e15d03f542fa…` | current |
| [`tr-conservation-time-order`](reports/tr-conservation-time-order.md) | tr-conservation | 验证 | 成立 | 1.4 | 2026-09-18 | 草稿 | `sha256:e15d03f542fa…` | current |
| [`tr-coupling-equilibrium-outer-loop`](reports/tr-coupling-equilibrium-outer-loop.md) | tr-coupling | 验证 | 成立 | 1.5 | 2026-09-18 | 草稿 | `sha256:e15d03f542fa…` | current |
| [`tr-coupling-nn-weights-external`](reports/tr-coupling-nn-weights-external.md) | tr-coupling | 验证 | 成立 | 1.5 | 2026-09-18 | 草稿 | `sha256:e15d03f542fa…` | current |
| [`tr-equations-boundary-family`](reports/tr-equations-boundary-family.md) | tr-equations | 验证 | 成立 | 3.3 | 2026-09-18 | 草稿 | `sha256:e15d03f542fa…` | current |
| [`tr-equations-channel-descriptor`](reports/tr-equations-channel-descriptor.md) | tr-equations | 验证 | 成立 | 1.3 | 2026-09-18 | 草稿 | `sha256:e15d03f542fa…` | current |
| [`tr-paradigm-coupled-block-adr`](reports/tr-paradigm-coupled-block-adr.md) | tr-paradigm | 验证 | 未判（读数） | 1.5 | 2026-09-18 | 草稿 | `sha256:e15d03f542fa…` | current |
| [`tr-paradigm-flux-match-vs-pde`](reports/tr-paradigm-flux-match-vs-pde.md) | tr-paradigm | 验证 | 成立 | 1.5 | 2026-09-18 | 草稿 | `sha256:e15d03f542fa…` | current |
| [`tr-paradigm-pereverzev`](reports/tr-paradigm-pereverzev.md) | tr-paradigm | 验证 | 未判（读数） | 1.7 | 2026-09-18 | 草稿 | `sha256:e15d03f542fa…` | current |
| [`tr-pedestal-sawtooth-kadomtsev`](reports/tr-pedestal-sawtooth-kadomtsev.md) | tr-pedestal | 验证 | 成立 | 1.5 | 2026-09-18 | 草稿 | `sha256:e15d03f542fa…` | current |
| [`tr-pedestal-zerod-bookkeeping-metis`](reports/tr-pedestal-zerod-bookkeeping-metis.md) | tr-pedestal | 对拍 | 不成立 | 1.7 | 2026-09-18 | 草稿 | `sha256:e15d03f542fa…` | current |
