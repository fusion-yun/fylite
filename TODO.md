...
**同日 D 组续做**（EAST 标准算例：E-7 · E-8 立项，E-2 清单短一截，新 `F-14`）。本表收**本仓及其上下游**当前未完成的事项——之所以合在一处，是因为它们
...
★**本仓能自己做完**的现在是 F-1 / F-2 / F-12 / **F-14**（F-4 · F-5 · F-6 已关）；F-9 要先定走哪边；F-8 要对外联系；F-10 / F-13 归 fydoc（F-3 · F-11 已关），登记在此只为让本仓知道自己在等什么。
