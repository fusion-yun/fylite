...
★**本仓能自己做完**的现在是 F-1 / F-2 / F-12 / **F-14** / **F-16** / **F-18**（F-4 · F-5 · F-6 已关）；内核侧自己能做完的是 **F-15** / **F-17** / **F-21** / **F-22** / **F-23**（F-17 只差改 import）；F-9 要先定走哪边；F-8 要对外联系；F-10 / F-13 / **F-19** 归 fydoc（F-3 · F-11 已关），**F-20** 要第二台机器的实测放电；**F-25 已裁定并做完（ABI 153）· F-26 仍等一次裁定，不等测量；F-27 等的是接线与参照件；F-28 排在 EC 的 L2 过判据之后**，登记在此只为让本仓知道自己在等什么。
