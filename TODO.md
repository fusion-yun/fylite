...
| **F-28** | kernel | 缺一个**可复算的束宽参照件**（B 类）。2026-09-13 逐篇查过库内 11 篇 L3 全文，无一同时公开完整输入与定量束宽；再要的三篇（Figini 2012 · Weber 2015 · Poli 等 2001 FED）**未取到全文**，书目在 `Reference/download/fylite-f28-beam-reference-papers.bib` |
