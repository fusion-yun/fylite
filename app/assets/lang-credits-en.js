...
self.FyI18n.register('en', {
  ...
  'cr.license.files': '★This page — the browser demos under <code>app/</code> — and the compute kernels it loads are under the same licence: the kernels are built from this repository\'s own sources, and each artifact\'s sha256 and provenance are recorded in the repository documentation, so they can be checked byte for byte.',
