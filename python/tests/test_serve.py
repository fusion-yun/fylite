...
def test_semantic_file_loads_like_a_plain_one(tmp_path):
    #: a set built on NPROBE is read against the bound card itself (the efit_east selection it
    #: used left with the user ruling 2026-09-15: that tree is comparison data only)
