...
#: chain -> shot to resolve on (None: no shot).  ★The efit_east chain left the device book
#: (user ruling 2026-09-15: that tree is comparison data only).
CHAINS = {"pcs_east": None, "east": None}
