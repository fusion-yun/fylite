...
TABLES = {
    'CORE_PROFILES': {
        ...
        "slots": {
            ...
            'sigma_prev': {"path": 'profiles_1d/fylite:sigma_prev', "units": 'ohm^-1.m^-1', "rank": '1d'},
            'exch_prev': {"path": 'profiles_1d/fylite:exch_prev', "units": 's^-1', "rank": '1d'},
            'dn_prev': {"path": 'profiles_1d/fylite:dn_prev', "units": 'm^2.s^-1', "rank": '1d'},
            'vn_prev': {"path": 'profiles_1d/fylite:vn_prev', "units": 'm.s^-1', "rank": '1d'},
        },
    },
    'CORE_SOURCES': {
    ...
    'CORE_TRANSPORT': {
        ...
        "slots": {
            ...
            'chi_e': {"path": 'profiles_1d/electrons/energy/d', "units": 'm^2.s^-1', "rank": '1d'},
    ...
    'DISCHARGE': {
        ...
        "slots": {
            ...
            'flux_loop': {"path": 'fylite:flux_loop', "units": 'Wb.rad^-1', "rank": '1d'},
            ...
            'psi_warm': {"path": 'fylite:psi_warm', "units": 'Wb', "rank": '1d'},
        },
    },
    'EC_LAUNCHERS': {
    ...
    'EQUILIBRIUM': {
        ...
        "slots": {
            ...
            'f_df_dpsi': {"path": 'time_slice/profiles_1d/f_df_dpsi', "units": 'T^2.m^2.Wb^-1', "rank": '1d'},
            'dpressure_dpsi': {"path": 'time_slice/profiles_1d/dpressure_dpsi', "units": 'Pa.Wb^-1', "rank": '1d'},
    ...
    'LH_ANTENNAS': {
        ...
        "slots": {
            ...
            'spectrum': {"path": 'antenna/row/power_density_spectrum_1d', "units": 'W', "rank": '1d'},
            'spectrum_2d': {"path": 'antenna/row/power_density_spectrum_2d', "units": 'W', "rank": '2d'},
        },
    },
    'MAGNETICS': {
        "type": 'fyo:magnetics',
    ...
    'NBI': {
        ...
        "slots": {
            ...
            'mass': {"path": 'unit/species/a', "units": 'u', "rank": '0d'},
            'charge': {"path": 'unit/species/z_n', "units": 'e', "rank": '0d'},
    ...
    'TRANSPORT_INPUTS': {
        ...
        "slots": {
            ...
            'velocity': {"path": 'fylite:velocity', "units": 'm.s^-1', "rank": '1d'},
            'chi_given': {"path": 'fylite:chi_given', "units": 'm^2.s^-1', "rank": '1d'},
            'chi_turb': {"path": 'fylite:chi_turb', "units": 'm^2.s^-1', "rank": '1d'},
            'chi_prev': {"path": 'fylite:chi_prev', "units": 'm^2.s^-1', "rank": '1d'},
...
BLOCKS = {
    ...
    'EVOLVE_HEAT_IN': [
        ...
        {'key': 'sigma_prev', 'shape': 'n', 'units': 'ohm^-1.m^-1', 'gloss': 'the parallel conductivity that step used'},
        {'key': 'exch_prev', 'shape': 'n', 'units': 's^-1', 'gloss': "the exchange rates that step's closure produced"},
        {'key': 'zeff_prev', 'shape': 'n', 'units': '1', 'gloss': "the Z_eff that step's closure produced (zeros = none)"},
        {'key': 'dn_prev', 'shape': 'n', 'units': 'm^2.s^-1', 'gloss': "the particle diffusivity that step's closure produced"},
        {'key': 'vn_prev', 'shape': 'n', 'units': 'm.s^-1', 'gloss': "the particle pinch that step's closure produced"},
        {'key': 'chi_e_in', 'shape': 'n', 'units': 'm^2.s^-1', 'gloss': 'electron heat diffusivity profile (chi_source = 1)'},
        {'key': 'chi_i_in', 'shape': 'n', 'units': 'm^2.s^-1', 'gloss': 'ion heat diffusivity profile (chi_source = 1)'},
        {'key': 'r2', 'shape': 'n', 'units': 'm^2', 'gloss': "<R^2> on the ladder — the momentum capacity's weight (ch_momentum = 1)"},
        {'key': 'omega_init', 'shape': 'n', 'units': 's^-1', 'gloss': 'the rotation the block starts from (zeros = at rest)'},
    ...
    'EVOLVE_HEAT_OUT': [
        ...
        {'key': 'sigma_prev_out', 'shape': 'n', 'units': 'ohm^-1.m^-1', 'gloss': 'the conductivity to hand it'},
        {'key': 'exch_prev_out', 'shape': 'n', 'units': 's^-1', 'gloss': 'the exchange rates to hand it'},
        {'key': 'dn_prev_out', 'shape': 'n', 'units': 'm^2.s^-1', 'gloss': "the particle diffusivity the last step's closure produced"},
        {'key': 'vn_prev_out', 'shape': 'n', 'units': 'm.s^-1', 'gloss': "the particle pinch the last step's closure produced"},
        ...
        {'key': 'omega', 'shape': 'n', 'units': 's^-1', 'gloss': 'the toroidal rotation the loop reached'},
        {'key': 'omega_axis', 'shape': 'nt', 'units': 's^-1', 'gloss': 'axis rotation trace'},
        {'key': 'd_n', 'shape': 'n', 'units': 'm^2.s^-1', 'gloss': "the main ion's particle diffusivity the last step used"},
        {'key': 'v_n', 'shape': 'n', 'units': 'm.s^-1', 'gloss': 'its convection velocity'},
        ...
        {'key': 'chi_neo', 'shape': 'n', 'units': 'm^2.s^-1', 'gloss': 'the neoclassical ion diffusivity the last step used (zeros on the other closures)'},
    ...
    'EVOLVE_HEAT_PARAMS': [
        ...
        {'key': 'chi0', 'shape': '1', 'units': 'm^2.s^-1', 'gloss': 'constant-closure ion diffusivity'},
        ...
        {'key': 'd_pc', 'shape': '1', 'units': 'm^2.s^-1', 'gloss': 'Pereverzev-Corrigan coefficient'},
        ...
        {'key': 'pinch', 'shape': '1', 'units': 'm.s^-1', 'gloss': "the main ion's convection velocity in Gamma = -D dn/drho + v n (prescribed)"},
        {'key': 'fuel', 'shape': '1', 'units': 's^-1', 'gloss': 'fuelling rate, deposit-normalised (particles per second into the main ion)'},
        ...
        {'key': 'imp_mass', 'shape': '1', 'units': 'u', 'gloss': "the impurity's mass number (the alpha's field-ion sum; quasi = 1)"},
        {'key': 'd_over_chi_z', 'shape': '1', 'units': '1', 'gloss': "the impurity's D as a fraction of chi_e (quasi = 1, ch_density = 1)"},
        {'key': 'pinch_z', 'shape': '1', 'units': 'm.s^-1', 'gloss': "the impurity's convection velocity"},
        ...
        {'key': 'ip_ki', 'shape': '1', 'units': 'V.s^-1', 'gloss': 'integral gain'},
    ...
    'TRANSPORT_IN': [
        ...
        {'key': 'vprime', 'shape': 'n', 'units': 'm^2', 'gloss': 'dV/drho'},
        {'key': 'source', 'shape': 'n', 'units': 'eV.s^-1', 'gloss': 'the source RATE the operator takes'},
        {'key': 'velocity', 'shape': 'n', 'units': 'm.s^-1', 'gloss': 'the convection of the flux'},
    ],
    'TRANSPORT_OUT': [
    ...
    'TRANSPORT_PARAMS': [
        ...
        {'key': 'p0', 'shape': '1', 'units': 'm^2.s^-1', 'gloss': "the closure's leading coefficient"},
    ...
    'VSTAB_IN': [
        ...
        {'key': 'g', 'shape': 'n', 'units': 'H.m^-1', 'gloss': 'the vertical coupling gradient'},
    ],
    'VSTAB_OUT': [
        {'key': 'm_star', 'shape': 'n*n', 'units': 'H', 'gloss': 'the eliminated inductance matrix'},
        {'key': 'c_xi', 'shape': 'n', 'units': 'H.m^-1', 'gloss': "the mode's coupling vector"},
        {'key': 'mode', 'shape': 'n', 'units': '1', 'gloss': 'the unstable mode shape'},
        {'key': 'gamma', 'shape': '1', 'units': 's^-1', 'gloss': 'the open-loop growth rate'},
...
CODE_PARAMS = {
    ...
    'discharge': {"door": 'discharge_case', "crate": 'fylite_kernel', "parameters": {
        ...
        'accept_gate': {'key': 'accept_gate', 'type': 'boolean', 'via': 'discharge_case', 'default': 'false'},
        'accept_tol': {'key': 'accept_tol', 'type': 'float', 'via': 'discharge_case', 'default': '0.0', 'required': False},
        'anchor_passes': {'key': 'anchor_passes', 'type': 'float', 'via': 'discharge_case', 'default': '1.0', 'required': False},
        ...
        'c4_fb_r_in': {'key': 'c4_fb_r_in', 'type': 'float', 'via': 'discharge_case', 'default': '0.0', 'required': False},
        'c4_fb_z_in': {'key': 'c4_fb_z_in', 'type': 'float', 'via': 'discharge_case', 'default': '0.0', 'required': False},
        'c4_int_r_in': {'key': 'c4_int_r_in', 'type': 'float', 'via': 'discharge_case', 'default': '0.0', 'required': False},
        'c4_int_z_in': {'key': 'c4_int_z_in', 'type': 'float', 'via': 'discharge_case', 'default': '0.0', 'required': False},
        'c4_warm': {'key': 'c4_warm', 'type': 'boolean', 'via': 'discharge_case', 'default': 'false'},
        'card_limits': {'key': 'card_limits', 'type': 'float', 'via': 'discharge_case', 'default': '1.0', 'required': False},
        'collapse_frac': {'key': 'collapse_frac', 'type': 'float', 'via': 'discharge_case', 'default': '0.25', 'required': False},
        ...
        'edge_fraction': {'key': 'edge_fraction', 'type': 'float', 'via': 'discharge_case', 'default': '1.0', 'required': False},
        ...
        'max_iter': {'key': 'max_iter', 'type': 'float', 'via': 'discharge_case', 'default': 'if edge_rule { 3000.0 } else { 600.0 }', 'required': False},
        ...
        'pc_track_r0': {'key': 'pc_track_r0', 'type': 'float', 'via': 'discharge_case', 'default': '0.0', 'required': False},
        ...
        'r0_hard': {'key': 'r0_hard', 'type': 'boolean', 'via': 'discharge_case', 'default': 'false'},
        'relax': {'key': 'relax', 'type': 'float', 'via': 'discharge_case', 'default': '0.3', 'required': False},
        'response': {'key': 'response', 'type': 'string', 'via': 'discharge_case'},
        'response_step': {'key': 'response_step', 'type': 'float', 'via': 'discharge_case', 'default': '0.01', 'required': False},
        ...
        'x_ctl': {'key': 'x_ctl', 'type': 'boolean', 'via': 'discharge_case', 'default': 'false'},
        'x_ctl_gain': {'key': 'x_ctl_gain', 'type': 'float', 'via': 'discharge_case', 'default': '0.3', 'required': False},
        'x_hard': {'key': 'x_hard', 'type': 'boolean', 'via': 'discharge_case', 'default': 'false'},
    ...
    'evolve': {"door": 'evolve', "crate": 'fylite_kernel', "parameters": {
        ...
        'gas_mass_amu': {'key': 'gas_mass_amu', 'type': 'float', 'via': 'evolve', 'default': '2.5', 'required': False},
        'gas_particles': {'key': 'gas_particles', 'type': 'float', 'via': 'evolve', 'default': '1e4', 'required': False},
        'gas_rate': {'key': 'gas_rate', 'type': 'float', 'via': 'evolve', 'default': '0.0', 'required': False},
        ...
        'lh_model': {'key': 'lh_model', 'type': 'string', 'via': 'evolve'},
        'lh_off_factor': {'key': 'lh_off_factor', 'type': 'float', 'via': 'evolve', 'default': '0.8', 'required': False},
        'lh_on_factor': {'key': 'lh_on_factor', 'type': 'float', 'via': 'evolve', 'default': '1.0', 'required': False},
        'lh_phase_in': {'key': 'lh_phase_in', 'type': 'float', 'via': 'evolve', 'default': '0.0', 'required': False},
        ...
        'orbit_losses': {'key': 'orbit_losses', 'type': 'float', 'via': 'beam_eval'},
        'particle_books': {'key': 'particle_books', 'type': 'boolean', 'via': 'evolve', 'default': 'false'},
        ...
        'pinch_shape': {'key': 'pinch_shape', 'type': 'string', 'via': 'evolve'},
    ...
    'forces': {"door": 'forces_case', "crate": 'fylite_kernel', "parameters": {
        'nu': {'key': 'nu', 'type': 'float', 'via': 'forces_case', 'default': '8.0', 'required': False},
        'nv': {'key': 'nv', 'type': 'float', 'via': 'forces_case', 'default': '8.0', 'required': False},
    }},
    'forward': {"door": 'forward_case', "crate": 'fylite_kernel', "parameters": {
        ...
        'edge_fraction': {'key': 'edge_fraction', 'type': 'float', 'via': 'forward_case', 'default': '1.0', 'required': False},
        ...
        'max_iter': {'key': 'max_iter', 'type': 'float', 'via': 'forward_case', 'default': 'if edge { 3000.0 } else { 600.0 }', 'required': False},
    ...
    'reconstruction': {"door": 'reconstruction_case', "crate": 'fylite_kernel', "parameters": {
        ...
        'border': {'key': 'border', 'type': 'string', 'via': 'reconstruction_case'},
        ...
        'newton_krylov': {'key': 'newton_krylov', 'type': 'float', 'via': 'reconstruction_case', 'default': '0.0', 'required': False},
    ...
    'wall': {"door": 'wall_case', "crate": 'fylite_kernel', "parameters": {
        ...
        'screen_coils': {'key': 'screen_coils', 'type': 'boolean', 'via': 'wall_case', 'default': 'false'},
    }},
    ...
    'zerod': {"door": 'zerod_case', "crate": 'fylite_kernel', "parameters": {
        ...
        'kappa_axis': {'key': 'kappa_axis', 'type': 'float', 'via': 'zerod_case', 'default': '0.0', 'required': False},
        ...
        'shift_axis': {'key': 'shift_axis', 'type': 'float', 'via': 'zerod_case', 'default': '0.0', 'required': False},
