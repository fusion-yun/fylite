...
// 装置数据入 `webui/`，而分仓之后 `webui/facts/device/east.jsonld` 与 `iter.jsonld` 是随
// `webui/` 一起发布的**真文档**（不是链接——分仓那阵它们曾是指向 `machine_desc/`
...
//: ★**只有这一处来源了**。从前这里先看 `webui/facts/device/`（指向仓根 `facts/` 的
