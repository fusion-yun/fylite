...
//
//   node webui/tests/validate-mds-page.mjs [--playwright DIR] [--chrome BIN]
//
// ★It brings its own site.  `_site.mjs` serves `webui/` off the disk, puts the
...
//:   node tools/mds-record.mjs --server <站点> --port 8210 --out webui/tests/fixtures/mdsip-east.json
//:   FYLITE_MDSIP_LIVE=127.0.0.1:8210 node webui/tests/validate-mds-page.mjs …
