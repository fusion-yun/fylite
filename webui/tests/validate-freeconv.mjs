...
// `webui/tests/README.md` states for every gate that compares the ones that
// worked with the ones that did not.
//
//   node webui/tests/validate-freeconv.mjs [--playwright DIR] [--chrome BIN]
//                                        [--url BASE]
...
const BASE = flag('url') || 'http://127.0.0.1:8767/webui/';
