...
//
//   node webui/tests/validate-em-hosts.mjs
...
const FORBIDDEN = [
  { file: 'webui/assets/worker.js', re: /2\s*\*\s*Math\.PI\s*\*\s*\w+\.r\s*\/\s*\(/,
    what: '真空室电阻公式内联' },
  { file: 'webui/assets/worker.js', re: /M\.channels\.forEach/,
    what: '通道图在页面里被重走' },
  { file: 'webui/assets/worker.js', re: /\.br\[[^\]]*\]\s*\*\s*ca/,
    what: '探针角投影内联' },
  { file: 'webui/assets/fylite.js', re: /lr\.fill\(/,
  ...
  { file: 'webui/assets/fylite.js', re: /Fy\.prototype\.(elementResponse|channelField|channelWeights|elementProbeResponse)\b/,
    what: '电磁点响应的扁平原型回来了' },
];
