// Gate for `webui/facts/device/east-signals.json` — the EAST diagnostic catalogue.
//
//   node webui/tests/validate-east-catalog.mjs
//   FYLITE_MDSIP_SERVER=127.0.0.1:8000 node webui/tests/validate-east-catalog.mjs
//
...
if (!existsSync(CATALOGUE)) {
  ...
  console.log('    cp <fydata>/corpus/device/east/east_signals.json webui/facts/device/east-signals.json');
...
//: `webui/server/` 之前，这道门 import 的是 Node 客户端的 `isNodePath` /
