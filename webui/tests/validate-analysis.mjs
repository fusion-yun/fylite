...
//
//   node webui/tests/validate-analysis.mjs [--playwright DIR] [--chrome BIN] [--url BASE]
...
const BASE = iu > 0 ? process.argv[iu + 1] : 'http://127.0.0.1:8767/webui/';
...
// anything at all — the degenerate pass `webui/tests/README.md` forbids.  And
...
//: the bus is the documented gate entry (`webui/tests/README.md`): the slice
