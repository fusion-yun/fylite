...
//
//   node webui/tests/validate-jmds.mjs
//   FYLITE_MDSIP_SERVER=<host:port> node webui/tests/validate-jmds.mjs
//
...
if (!SERVER) {
  ...
  info('  FYLITE_MDSIP_SERVER=host:port node webui/tests/validate-jmds.mjs');
} else {
