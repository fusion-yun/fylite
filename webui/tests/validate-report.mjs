...
// from a record and renders MyST + SVG; `webui/assets/casereport.js` is a port
...
//
//     node webui/tests/validate-report.mjs [--playwright DIR] [--chrome PATH]
...
await page.goto('file://' + join(ROOT, 'webui/pages/report.html'));
