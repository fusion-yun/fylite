...
//
// Run: node webui/tests/validate-worker-recon.mjs [--record | --strip-readings]
...
if (!RECORD) {
  ...
  assert.deepEqual(left, [], 'EAST shot readings in the public fixture (node webui/tests/validate-worker-recon.mjs --strip-readings)');
