...
//
// ★★A preset is an fyo/JSON-LD document under `webui/facts/device/`, listed by
// `webui/facts/device/catalogue.jsonld`, and parsed by `FyoDevice.fromFyo` — the
...
//: ★2026-09-05 用户裁定：仓顶已无 `facts/`，也没有 `webui/facts` 那条链接；
