...
//
// ★This page has NO kernel and NO worker.  Every other page in `webui/` runs
...
(function (root) {
  ...
  /**
   * ★Every request is SAME-ORIGIN and relative.  The gateway serves `webui/`
  ...
  function exportWorkspace() {
    var doc = {
      ...
      saved_by: 'webui/pages/data.html (fylite)',
